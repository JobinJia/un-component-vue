...
import type { SlotsType, VNode, Component } from 'vue';
export type CustomSlotsType = {
...
export type FormSchema<C extends FormContentComponentPropsKeys = FormContentComponentPropsKeys, F extends FormItemPropsKeys = FormItemPropsKeys, G extends FormGroupPropsKeys = FormGroupPropsKeys> = {
    [K in C]: SchemaItem<K, F, G>;
}[C];
export type FormSchemas<C extends FormContentComponentPropsKeys = FormContentComponentPropsKeys, F extends FormItemPropsKeys = FormItemPropsKeys, G extends FormGroupPropsKeys = FormGroupPropsKeys> = FormSchema<C, F, G>[];
export {};
